    ...
    <section id="contact-us">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h1 class="heading wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">search <span>Question</span></h1>
						<br>
                        <div class="row">
                            <div class="col-md-12">
                                <script>
                        ...
                        <!--form-->
                        <form class="form-horizontal" role="form" action="searched.php" method="POST">
                        ...
                        <button class="btn btn-default wow bounceIn" role="button" type=submit>Search Question</button>                        
						</form>
						<!--end of form-->
                    </div>
                </div><!-- .col-md-12 close -->
