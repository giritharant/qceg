<?php
	...
	if(!$_SESSION['u_name'])
	{
        ...
        $select="select * from qdonor where email='$_SESSION[u_email]'";
        $store=mysqli_query($con,$select);
        $log=mysqli_fetch_array($store);
        if(!$log['email'])
        {
	        
	        header('location:qdonor.php');
        } 
        /*else {
             header('location:qdonor.php');
        }*/
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
						...
						<br>
                        <!--form-->
                        <form class="form-horizontal" role="form" action="uploading.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control" name="fileToUpload" id="fileToUpload" placeholder="Upload Your File here...">
							</div>
						</div>
                        <button class="btn btn-default wow bounceIn" role="button" type=submit>Upload Your Question</button>                        
						</form>
						<!--end of form-->
                    </div>
                </div><!-- .col-md-12 close -->
